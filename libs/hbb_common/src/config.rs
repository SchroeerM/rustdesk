...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("de.drei-web".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("dRei Support".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.drei.wtf"];
pub const PUBLIC_RS_PUB_KEY: &str = "k67q80PW0azgiC7+6hMuxRvuXyBhZQDWnzGHg4DZIyk=";
